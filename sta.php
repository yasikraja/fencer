       ...
       var xmlhttp = new XMLHttpRequest();
        ...
        xmlhttp.onreadystatechange = function() 
		{
            if (this.readyState == 4 && this.status == 200) 
			{
				...
				document.getElementById('st_load').style.display='block';
            }
        };
...
<?php
  ...
  <div id="st_load" class="w3-modal">
    <div class="w3-modal-content w3-card-4" style="max-width:600px">
    <span onclick="document.getElementById('st_load').style.display='none'" class="w3-button w3-xlarge w3-hover-red w3-display-topright" title="Close Modal">&times;</span>
