...
$sql="insert into $tq(qid,ques,otype,nopts,ans,points,opt,expl) values($id,'$ques','$opt_type',$nof_opt,'$ans',$p,'$opt_ans','$ex')";
...
<form method="post" action="editques.php" class="w3-container">
